        ...
        <div className="mb-10 rounded-sm border border-forge-700 bg-forge-900/60 p-6 shadow-xl">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
            ...
            <div className="flex w-full flex-col justify-between gap-6 self-stretch">
              ...
              {/* Redes e Contato usando a classe .hover-lift */}
                ...
                <div className="flex items-center gap-2">
                  {SOCIAL_LINKS.map((social) => (
                    <a
                      ...
                      title={social.label}
                      className="hover-lift flex h-9 w-9 items-center justify-center rounded-sm border border-forge-700 bg-forge-950/80 text-steel hover:text-ember"
                    >
                      {social.icon}
                    </a>
                  ))}
